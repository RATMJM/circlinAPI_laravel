...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/common.css?202206031548') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/board.css?202206031548') }}">
...
<div id="header">
    <div class="container">
        <ul id="nav">
            ...
            <li><a href="{{ route('admin.banner.index') }}">배너 관리</a></li>
