...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        $orders = Order::join('users', 'users.id', 'orders.user_id')
            ...
            ->join('order_product_options', 'order_product_options.order_product_id', 'order_products.id')
            ->join('product_options', 'product_options.id', 'order_product_options.product_option_id')
            ->leftJoin('order_product_deliveries', 'order_product_deliveries.order_product_id', 'order_products.id')
            ->select([
                'orders.order_no', 'users.nickname', 'users.email',
                'products.name_ko as product_name', 'product_options.name_ko as option_name', 'order_products.qty',
