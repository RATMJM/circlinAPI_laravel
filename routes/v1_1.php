...
//     Route::get('/{town?}', [v1_1\MissionCategoryController::class, 'index'])->where(['town' => 'town'])->name('index');  # 'town' => favorite categories + 현재 참가중인 미션들의 category + 스페셜미션 // !'town' => 스페셜 미션 외 모든 미션 카테고리
//     Route::get('/{category_id}', [v1_1\MissionCategoryController::class, 'show'])->name('show');  # 전체
//     Route::get('/{category_id}/mission', [v1_1\MissionCategoryController::class, 'mission'])->name('mission');
//     Route::get('/{category_id}/challenge', [v1_1\MissionCategoryController::class, 'challenge'])->name('challenge');
...
//     Route::get('/challenge', [v1_1\MypageController::class, 'challenge'])->name('challenge');
